    ...
    afterRender() {
        ...
        const checkStatus = async () => {
            ...
            try {
                ...
                if (!token) return;
                const response = await fetch((window.GLOBAL_API_BASE || '') + '/api/student-profile/biometric/status', {
            ...
            const startScan = async () => {
                ...
                setTimeout(async () => {
                    ...
                    try {
                        ...
                        const response = await fetch((window.GLOBAL_API_BASE || '') + '/api/student-profile/biometric/enroll', {
                            method: 'POST',
                            headers: {
                        ...
                        if (response.ok && data.success) {
                            ...
                            window.dispatchEvent(new CustomEvent('verification-status', { detail: { verified: true } }));
                        } else {
