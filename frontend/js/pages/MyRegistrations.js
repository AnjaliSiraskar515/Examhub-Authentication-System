    ...
    const fetchAndRender = async () => {
        ...
        try {
            ...
            const [regResponse, profileResponse, examsResponse] = await Promise.all([
                fetch('http://localhost:8081/api/student/registrations?studentId=1', { headers }),
                fetch('http://localhost:8081/api/profile/info', { headers }),
                fetch('http://localhost:8081/api/university/exams', { headers })
            ]);
